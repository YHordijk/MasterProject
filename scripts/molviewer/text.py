...
# fontfile = os.path.join(paths.fonts, 'Xerox Sans Serif Narrow Bold.ttf')
#fontfile = r'C:\source\resource\fonts\gnu-freefont_freesans\freesans.ttf'
fontfile = r"D:\Users\Yuman\Desktop\MasterProject\resources\fonts\Xerox Sans Serif Narrow Bold.ttf"
